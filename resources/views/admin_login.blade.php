...
<meta name="description" content="Metro Admin Templete">
...
<!-- start: Favicon -->
<link rel="icon" href="{{URL::to('backend/img/faicon.png')}}">
<!-- end: Favicon -->	
<style type="text/css">
			...
			<form class="form-horizontal" action="{{url('/admin-dashboard')}}" method="post">
					...
					<fieldset>
						<div class="input-prepend" title="Username">
							...
							<input class="input-large span10" name="admin_email"  type="text" placeholder="type Email-Addres"/>
						</div>
