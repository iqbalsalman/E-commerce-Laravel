...
<head>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="{{URL::to('forntend/image/logofix.jpg')}}">
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +62-811-231-2496</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> picme@.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="wwww.facebook.com/uwaumir"><i class="fa fa-facebook"></i></a></li>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="image/logofix.jpg" style="width: 80px; height: 80px;" alt="" /></a>
						</div>
	...
	@php
		$all_publishhed_slide = DB::table('tbl_slider')
			...
			<div class="row">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators">
								@foreach( $all_publishhed_slide  as $photo )
							...
							<div class="carousel-inner" role="listbox">
								@foreach( $all_publishhed_slide  as $item )
									<div class="item {{ $loop->first ? ' active' : '' }}" >
											<img src="{{URL::to($item->slider_image)}}" style="width: 100%; height: 200pz;">
									</div>
								@endforeach
							</div>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
							 ...
							 <div class="panel panel-default">
									...
									<h4 class="panel-title"><a href="{{URL::to('/product_by_category/'.$item->category_id)}}">
												{{$item->category_name}}
										</a>
										</h4>
									</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
										@php
										$all_publishhed_manufacture = DB::table('tbl_manufacture')
																	  ->where('publications_status',1)
																	  ->get();								   
									@endphp
									@foreach ($all_publishhed_manufacture as $item)
									<li><a href="{{URL::to('/product_by_manufacture/'.$item->manufacture_id)}}"> <span class="pull-right">(10)</span>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="{{URL::to('forntend/images/home/map.png')}}" alt="" />
